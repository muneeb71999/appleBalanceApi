              ...
              (n = [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    var t = this.engine;
                    this.subs.push(y.on(t, "data", d(this, "ondata"))),
                      this.subs.push(y.on(t, "ping", d(this, "onping"))),
                      this.subs.push(y.on(t, "error", d(this, "onerror"))),
                      this.subs.push(y.on(t, "close", d(this, "onclose"))),
                      this.subs.push(
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    ~e && this.connecting.splice(e, 1),
                      this.connecting.length || this._close();
                  },
                },
                {
                  key: "_packet",
                ...
                },
                {
                  ...
                  value: function () {
                    for (var t = 0; t < this.receiveBuffer.length; t++)
                      this.emitEvent(this.receiveBuffer[t]);
                    this.receiveBuffer = [];
                    for (var e = 0; e < this.sendBuffer.length; e++)
